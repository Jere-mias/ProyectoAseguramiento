...
class VentaController extends Controller
{
    ...
    public function reportec($id){
        ...
        $pdf::SetXY(115,20);
        $pdf::Cell(0,0,utf8_decode("Tipo de Documento:"));
        $pdf::SetXY(165,20);
        ...
        //Inicio con el reporte
        $pdf::SetXY(115,30);
        $pdf::Cell(0,0,utf8_decode("Serie: "));
        $pdf::SetXY(165,30);
        $pdf::Cell(0,0,utf8_decode($venta->serie_comprobante));
        $pdf::SetXY(115,40);
        $pdf::Cell(0,0,utf8_decode("Numero: "));
        $pdf::SetXY(165,40);
        ...
        $pdf::SetXY(30,60);
        $pdf::Cell(0,0,utf8_decode("Direccion Cliente: "));
        $pdf::SetXY(62,60);
        $pdf::Cell(0,0,utf8_decode($venta->direccion));
        //***Parte de la derecha
        $pdf::SetXY(30,70);
        $pdf::Cell(0,0,utf8_decode("Fecha Venta: "));
        $pdf::SetXY(62,70);
        ...
        $pdf::SetXY(40,85);
        $pdf::Cell(0,0,utf8_decode("Producto "));
        $pdf::SetXY(150,85);
        $pdf::Cell(0,0,utf8_decode("Precio Unidad "));
        $pdf::SetXY(180,85);
        ...
        $pdf::SetXY(187,153);
        $pdf::MultiCell(20,0,"Q/ ".sprintf("%0.2F", $venta->total_venta-($venta->total_venta*$venta->impuesto/($venta->impuesto+100))));
        $pdf::SetXY(187,160);
        $pdf::MultiCell(20,0,"Q/ ".sprintf("%0.2F", ($venta->total_venta*$venta->impuesto/($venta->impuesto+100))));
        $pdf::SetXY(187,167);
        $pdf::MultiCell(20,0,"Q/ ".sprintf("%0.2F", $venta->total_venta));
